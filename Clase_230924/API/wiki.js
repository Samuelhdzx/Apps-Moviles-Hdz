...
if (resultados.length > 0) {
    document.getElementById('resultados').textContent = `Resultadosdebúsquedpara"${terminoBusqueda}":`;
    ...
    document.getElementById('resultados').textContent = 'No seencontraron resultados. ';
    }
    }catch (error) {
    // En caso de error, mostrar un mensaje
    document.getElementById('resultados').textContent = 'Error alobtener los datos de Wikipedia. ';
    }
}
